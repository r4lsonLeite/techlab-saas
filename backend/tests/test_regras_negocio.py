...
# 🟢 AGORA OS IMPORTS ESTÃO IDÊNTICOS AOS DO MAIN.PY
import main
from core.database import get_db
from models import models

# ==========================================
# 1. PREPARAÇÃO DO AMBIENTE (O MUNDO FANTASMA)
# ==========================================
...
# Injetar os "overrides" na aplicação principal
...
# ==========================================
# 2. OS NOSSOS TESTES AUTOMATIZADOS
# ==========================================

def test_impedir_venda_de_peca_sem_stock():
    """ Tentar vender um produto físico que tem stock ZERO. """
    db = TestingSessionLocal()
...
def test_permitir_venda_de_servico_sem_stock():
    """ Tentar vender um SERVIÇO que tem stock ZERO. (DEVE PASSAR) """
    db = TestingSessionLocal()
